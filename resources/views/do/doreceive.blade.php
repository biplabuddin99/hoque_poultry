                                    ...
                                    <table class="table table-bordered mb-0 table-striped">
                                        ...
                                        <tbody id="product">
                                            <tr>
                                                ...
                                                <td>
                                                    <select class="form-select referance_number" value="" name="do_id[]" required>
                                                    </select>
...
var row=`<tr>
    ...
    <td>
        <select class="form-select referance_number" name="do_id[]" required>
        </select>
        <input type="hidden" class="dodetail_id" name="dodetail_id[]">
    </td>
    <td><input class="form-control ctn" type="text" name="ctn[]" onkeyup="getCtnQty(this)" value="" placeholder="ctn"></td>
