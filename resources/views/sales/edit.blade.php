                            ...
                            <div class="row p-2 mt-4">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" onkeyup="TotalPriceCount(this);" onchange="TotalPriceCount(this);" placeholder="কেজি" min="0" step="0.01" class="form-control kg" value="{{ old('kg',$sales->kg)}}" name="kg">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="gm">{{__('গ্রাম')}}</label>
                                        <input type="number" onkeyup="TotalPriceCount(this);" onchange="TotalPriceCount(this);" placeholder="গ্রাম" min="0" step="0.01" class="form-control gm" value="{{ old('gm',$sales->gm)}}" name="gm">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="product_price">{{__('দর')}}</label>
                                        <input type="number" onkeyup="TotalPriceCount(this);" onchange="TotalPriceCount(this);" placeholder="দর" min="0" step="0.01" class="form-control product_price" value="{{ old('product_price',$sales->product_price)}}" name="product_price">
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" placeholder="মোট টাকা" min="0" step="0.01" class="form-control total_taka" value="{{ old('total_taka',$sales->total)}}" name="total_taka">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        <label for="collection_taka">{{__('জমা টাকা')}}</label>
                                        <input type="number" placeholder="জমা টাকা" min="0" step="0.01" class="form-control collection_taka" value="{{ old('collection_taka',$sales->collect_tk)}}" name="collection_taka">
                                    </div>
                                </div>
                                <div class="col-lg-4 col-md-6 col-sm-12">
                                    <div class="form-group">
