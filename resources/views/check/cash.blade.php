                ...
                <form action="">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6 d-flex justify-content-Start">
                            <a href="{{ route(currentUser().'.check_list_cash') }}" class="btn pbtn btn-sm btn-warning me-1 mb-1 ps-5 pe-5">{{__('Clear')}}</a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered mb-0"><thead>
                            ...
                            <tbody>
                                ...
                                <th scope="row">{{ ++$loop->index }}</th>
                                    ...
                                    <td class="text-end">{{money_format($d->balance_amount-$d->check_collect_amount)}}</td>
                                    {{-- <td class="white-space-nowrap">
                                        <button class="btn p-0 m-0" type="button" style="background-color: none; border:none;"
                                            ...
                                            data-shop-amount="{{$d->balance_amount-$d->check_collect_amount}}"
                                ...
                                @php
                                    $totalAmount += $d->balance_amount-$d->check_collect_amount;
                                @endphp
                                @empty
                                <tr>
