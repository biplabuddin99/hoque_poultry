                ...
                <form action="">
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6 d-flex justify-content-Start">
                            <a href="{{ route(currentUser().'.check_list_due') }}" class="btn pbtn btn-sm btn-warning me-1 mb-1 ps-5 pe-5">{{__('Clear')}}</a>
                        </div>
                    </div>
                    <div class="table-responsive">
                        ...
                        <table class="table table-bordered mb-0"><thead>
                            ...
                            <tbody>
                                @forelse($data as $d)
                                @php
                                    $totalDue = $d->balance_amount-($d->check_collect_amount+$d->collect_amount);
                                @endphp
                                @if ($totalDue > 0)
                                    <tr>
