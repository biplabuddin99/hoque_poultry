...
@section('pageTitle',trans('Update Return Product'))
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-content">
                    <div class="card-body">
                        <form class="form" method="post" enctype="multipart/form-data" action="{{route(currentUser().'.returnproduct.update',encryptor('encrypt',$return->id))}}">
                            @csrf
                            @method('PATCH')
                            <div class="row">
                                <div class="col-lg-2 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('driver_name',$return->driver_name)}}" name="driver_name">
                                ...
                                <div class="col-lg-2 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('helper',$return->helper)}}" name="helper">
                                ...
                                <div class="col-lg-2 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('invoice_number',$return->invoice_number)}}" name="invoice_number" required>
                                ...
                                <div class="col-lg-4 col-md-6 col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="note" rows="1">{{old('note',$return->note)}}</textarea>
                                    </div>
                                </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody id="retn_repeat">
                                        @forelse ($returnDetails as $rd)
                                            <tr>
                                                <td>
                                                    <select name="group_id[]" class="select2 form-control form-select return_group_id" id="group_id{{$rd->id}}" onchange="groupWiseProductShow(this);">
                                                        <option value="">Select Group</option>
                                                        @foreach ($group as $g)
                                                            <option value="{{$g->id}}" {{$rd->group_id == $g->id? 'selected' : ''}}>{{$g->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                <td>
                                                    <select name="product_id[]" class="form-control form-select return_product_id" id="product_id" onchange="productData(this);">
                                                        <option value="">Select Product</option>
                                                        @foreach ($product as $p)
                                                            <option class="selecet_p_hide selecet_p_hide{{$p->group_id}}" data-dp-price='{{$p->dp_price}}' value="{{$p->id}}" {{$rd->product_id == $p->id? 'selected' : ''}}>{{$p->product_name}}</option>
                                                        @endforeach
                                                    </select>
                                                </td>
                                                {{-- <td>
                                                ...
                                                <td>
                                                    <span onClick='addRow();' class="add-row text-primary" style="font-size:1rem; margin-left:9px;"><i class="bi bi-plus-square-fill"></i></span>
                                        ...
                                        @empty
                                            <tr>
                                                <td>
                                                    <select name="group_id[]" class="select2 form-control form-select return_group_id" id="group_id" onchange="groupWiseProductShow(this);">
                                                        <option value="">Select Group</option>
                                                        @foreach ($group as $g)
                                                ...
                                                <td>
                                                    <span onClick='addRow();' class="add-row text-primary" style="font-size:1.5rem; margin-left:9px;"><i class="bi bi-plus-square-fill"></i></span>
