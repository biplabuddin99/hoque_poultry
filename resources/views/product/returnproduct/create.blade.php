                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2 col-md-6 col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="{{ old('invoice_number')}}" name="invoice_number" required>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th><input type="text" name="grand_total" class="form-control text-end grand_total_amount" value="0" readonly></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
    ...
    function addRow(){
        ...
        <tr>
           ...
           {{-- <td>
            ...
            <td><input type="text" name="subtotal_price[]" class="form-control text-end subtotal_price" readonly></td>
            <td>
                <span onClick='removeRow(this);' class="delete-row text-danger" style="font-size:1.5rem; margin-left:9px;"><i class="bi bi-trash-fill"></i></span>
            </td>
        </tr>`;
