                                ...
                                <tbody>
                                    ...
                                    <tr class="tbl_border">
                                        <td class="tbl_border" style="text-align: center; padding: 5px;">
                                           @if($s->status_history=='0') Morning Out @elseif($s->status_history=='1') In Return @elseif($s->status_history=='2') In Damage @elseif($s->status_history=='3') Do Receive @elseif($s->status_history=='4') Out Damage @elseif($s->status_history=='5') Out Purchase Return @elseif($s->status_history=='6') Out display product @endif
                                        </td>
                                        <td class="tbl_border" style="text-align: center; padding: 5px;">
                                            {{ $s->stock_date }}
                                        </td>
                                        ...
                                        @php
                                            ...
                                            $totalAmountOuts += (($s->totalquantity_pcs)*($s->tp_price));
                                        @endphp
                                        @elseif($s->status_history =='6')
                                        <td class="tbl_border" style="text-align: center; padding: 5px;"></td>
                                        <td class="tbl_border" style="text-align: center; padding: 5px;"></td>
                                        <td class="tbl_border" style="text-align: center; padding: 5px;"></td>
                                        <td class="tbl_border" style="text-align: center; padding: 5px;">{{$s->totalquantity_pcs}}</td>
                                        <td class="tbl_border" style="text-align: center; padding: 5px;">{{$s->tp_free}}</td>
                                        <td class="tbl_border" style="text-align: center; padding: 5px;">{{$s->totalquantity_pcs*$s->tp_free}}</td>
                                        @php
                                            $actualQtyTotalOut += $s->totalquantity_pcs;
                                            $totalPcsOuts += $s->totalquantity_pcs;
                                            $totalAmountOuts += (($s->totalquantity_pcs)*($s->tp_free));
                                        @endphp
                                        @endif
                                        <td class="tbl_border" style="text-align: center; padding: 5px;">
                                             @php
